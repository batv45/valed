    ...
    */
    ...
    'connections' => [
        ...
        'syslog' => [
            ...
            'host' => env('SYSLOG_DB_HOST', '127.0.0.1'),
            'port' => env('SYSLOG_DB_PORT', '3306'),
            'database' => env('SYSLOG_DB_DATABASE', 'syslog'),
            'username' => env('SYSLOG_DB_USERNAME', 'rsyslog'),
            'password' => env('SYSLOG_DB_PASSWORD', ''),
            'unix_socket' => env('SYSLOG_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => null,
            'prefix_indexes' => true,
