<template>
  <Transition>
    ...
    >
      ...
      <div v-if="!onlyPagination" class="row g-2 p-2 m-0">
      ...
      <slot
        ...
        :meta="resourceMeta"
      >
        <TableWrapper :class="{ 'mt-1': !hasOnlyData }">
          <slot v-if="!onlyPagination" name="table">
            <table class="table table-responsive card-table table-nowrap mb-0 border-top"
